				...
				<div class="row justify-content-center">
					<form class="col-sm-10 col-md-8 col-lg-6">
						...
						<div class="form-check mb-3">
							<input type="checkbox" class="form-check-input" value="" id="checkLembrar">
							<label for="checkLembrar" class="form-check-label">Lembrar de mim</label>
						</div>
						
						<button class="btn  btn-lg btn-danger" type="button">Entrar</button>
						...
						<p class="mt-3">
							...
							Esqueceu sua senha?<a href="recuperarSenha.php">Clique aqui</a> para se recuperá-la.
						</p>
